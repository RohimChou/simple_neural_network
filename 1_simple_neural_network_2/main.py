...
if __name__ == "__main__":
    ...
    training_outputs = training_inputs * 2 + 3
    ...
    for inputs in np.array([1, 2, 3, 10, 20]):
        ...
        print(f"Inputs: {inputs}, Expected: {2 * inputs + 3}, Prediction: {prediction_denormalized[0]:.4f}, Rounded: {round(prediction_denormalized[0])}")