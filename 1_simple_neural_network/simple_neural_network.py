...
class SimpleNeuralNetwork:
    def __init__(self, learning_rate=0.2):
        ...
        self.weights = np.random.rand(2) # how important each input is
        self.bias = np.random.rand(1)    # how much to shift the output
    ...
    def train(self, training_inputs, training_outputs, epochs=2000):
        for epoch in range(epochs):
            ...
            print(f"\rEpoch {epoch+1:>3}, "
                  ...
                  f"SigDeri: {self.activate_fun_derivative(prediction):>5.3f}, "
